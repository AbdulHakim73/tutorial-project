                            ...
                            <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                                <div class="blog-item bg-light rounded overflow-hidden">
                                    <div class="blog-img position-relative overflow-hidden">
                                        <img class="img-fluid" src="{{ asset('storage/' . $page->photo) }}"
                                            alt="">
                                        ...
                                        @endif
                                        {{-- @if ($page->path == true)
                                            @foreach ($page->photo as $photos)
                                                <div class="comictop">
                                                    <img src="{{ URL::asset($photos->path) }}" alt=""
                                                        class="img-responsive">
                                                </div>
                                            @endforeach
                                        @else
                                            <div class="comictop">
                                                <img src="{{ URL::asset('/images/ina.png') }}" alt=""
                                                    class="img-responsive">
                                            </div>
                                        @endif --}}
                                    </div>
                                    <div class="p-4">
                                        <div class="d-flex mb-3">
                                            <small class="me-3"><i
                                                    class="far fa-user text-primary me-2"></i>{{ $page->name }}</small>
                                            <small><i
                                                    class="far fa-calendar-alt text-primary me-2"></i>{{ $page->created_at }}</small>
                                        </div>
                                        <h4 class="mb-3">{{ $page->short_content }}</h4>
                                        <p>{{ $page->content }}</p>
                                        <a class="text-uppercase" href="{{ route('pages.show', [$page->id]) }}">Read
